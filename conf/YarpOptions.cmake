...
#	set(CMAKE_CXX_FLAGS "-stdlib=libstdc++" CACHE STRING "Fixes linking error for m+m/ACE" FORCE)
	set(CMAKE_CXX_FLAGS "-std=c++11" CACHE STRING "Fixes linking error for m+m/ACE" FORCE)
#        set(CMAKE_OSX_DEPLOYMENT_TARGET "10.7" CACHE STRING "Deployment target for Mac OS X" FORCE)
    set(CMAKE_OSX_DEPLOYMENT_TARGET "10.9" CACHE STRING "Deployment target for Mac OS X" FORCE)
endif(APPLE)
